...
pays that cost ONCE — :func:`~agent_secret_redactor.configure_plugins` at
...
:func:`~agent_secret_redactor.handle_request` returns — the response object, or
...
from agent_secret_redactor import RedactorConfig, configure_plugins, handle_request
from agent_secret_redactor.engine import redact_configured
