...
from agent_secret_redactor import (
    RedactorConfig,
...
from conftest import SAMPLES, cfg, reconstruct, run_map, run_plain
...
def test_env_value_re_is_cached():
    from agent_secret_redactor.invisible import default_charset
