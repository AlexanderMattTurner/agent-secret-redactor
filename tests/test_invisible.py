...
from agent_secret_redactor import strip_invisible
from agent_secret_redactor.invisible import default_charset, invisible_run_pattern
...
def test_default_charset_fails_closed_without_shared_dep(monkeypatch):
    ...
    import agent_secret_redactor.invisible as redactor_inv
